...
namespace Shark.Credentials
{
    ...
    public class Web
    {
        public static void GetLogins()
        {
            ...
            Common.showMessage("[*]", "Try to get Web Credentials");
            ...
            //Common.showMessage("[*]", string.Format("Try to get {0}  ");
            ...
            for (int i = 0; i < vaultCount; i++)
            {
                ...
                if (vaultItemCount > 0)
                {
                    ...
                    for (int j = 1; j <= vaultItemCount; j++)
                    {
                        ...
                        //Console.WriteLine(passwordItem);
                        ...
                        try
                        {
                            ...
                            if (cred != null) // Indicates successful fetch
                            {
                                ...
                                Common.showBrowserPassword(GetVaultElementValue(pResourceElement).ToString(), GetVaultElementValue(pIdentityElement).ToString(), cred.ToString());
            ...
            Common.showMessage("[*]", "Try to get Web Credentials end");
